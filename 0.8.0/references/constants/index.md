...
Applied with config.set_theme. Every theme applied to the same set of charts is shown in the [Theme Gallery](https://eriknovak.github.io/datachart/0.8.0/how-to-guides/styling/theme-gallery/index.md).
...
Passed as the `orientation` setting of bar charts, histograms, and box plots.
