...
Combines different chart types (LineChart, BarChart, ScatterChart, Histogram) on a single plot, drawn in the order provided. Two value axes (primary and secondary) are supported for handling different scales.
