...
This section showcases the utility functions found in the [datachart.utils.stats](https://eriknovak.github.io/datachart/0.8.0/references/utils/stats) module.
...
The [dataset.utils.stats](https://eriknovak.github.io/datachart/0.8.0/references/utils/stats) submodule contains functions for calculating statistics. To showcase its use, let us create a list of random numbers:
