...
One `config` instance holds the style every chart is drawn with. Its methods change that style for the rest of the session, for one block of code, or from a file; the [Themes guide](https://eriknovak.github.io/datachart/0.10.2/how-to-guides/styling/themes/index.md) walks through them on a chart.
