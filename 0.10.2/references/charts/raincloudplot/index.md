...
A half violin, the raw points, and a box per group. The [Raincloud Plot guide](https://eriknovak.github.io/datachart/0.10.2/how-to-guides/charts/raincloudplot/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
