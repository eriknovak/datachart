...
The distribution of one numeric variable, binned. The [Histogram guide](https://eriknovak.github.io/datachart/0.10.2/how-to-guides/charts/histogram/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
