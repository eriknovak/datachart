...
This section showcases the Sankey chart. It contains examples of how to create Sankey charts using the [datachart.charts.SankeyChart](https://eriknovak.github.io/datachart/0.9.1/references/charts/#datachart.charts.SankeyChart) function.
...
As mentioned above, the Sankey charts are created using the `SankeyChart` function found in the [datachart.charts](https://eriknovak.github.io/datachart/0.9.1/references/charts/index.md) module. Let's import it:
...
For more details, see the [datachart.charts.SankeyChart](https://eriknovak.github.io/datachart/0.9.1/references/charts/#datachart.charts.SankeyChart) function.
...
A Sankey owns its axes: there is no shared coordinate space to overlay other charts on, so [datachart.utils.Panel](https://eriknovak.github.io/datachart/0.9.1/references/utils/#datachart.utils.Panel) rejects a Sankey figure. [datachart.utils.Grid](https://eriknovak.github.io/datachart/0.9.1/references/utils/#datachart.utils.Grid) arranges it next to other figures as an ordinary cell. The grid pairs the Sankey with a [datachart.charts.BarChart](https://eriknovak.github.io/datachart/0.9.1/references/charts/#datachart.charts.BarChart) of the survival rate per class.
