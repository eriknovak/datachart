...
This section showcases the raincloud plot. It contains examples of how to create raincloud plots using the [datachart.charts.RaincloudPlot](https://eriknovak.github.io/datachart/0.9.1/references/charts/#datachart.charts.RaincloudPlot) function.
...
As mentioned above, the raincloud plots are created using the `RaincloudPlot` function found in the [datachart.charts](https://eriknovak.github.io/datachart/0.9.1/references/charts/index.md) module. Let's import it:
...
For more details, see the [datachart.charts.RaincloudPlot](https://eriknovak.github.io/datachart/0.9.1/references/charts/#datachart.charts.RaincloudPlot) function.
...
The `mode` attribute chooses how the rain spreads across its width. It supports the values of the [datachart.constants.SWARM_MODE](https://eriknovak.github.io/datachart/0.9.1/references/constants/#datachart.constants.SWARM_MODE) constant:
...
The `datachart` package provides the [datachart.constants.ORIENTATION](https://eriknovak.github.io/datachart/0.9.1/references/constants/#datachart.constants.ORIENTATION) constant with these values.
...
A raincloud figure composes like any other chart. [datachart.utils.Panel](https://eriknovak.github.io/datachart/0.9.1/references/utils/#datachart.utils.Panel) overlays it with other charts on shared axes: the groups keep their positions, so a reference chart of the same categories lines up with them. Here a [datachart.charts.LineChart](https://eriknovak.github.io/datachart/0.9.1/references/charts/#datachart.charts.LineChart) traces the mean body mass across the species, one point per category position.
...
[datachart.utils.Grid](https://eriknovak.github.io/datachart/0.9.1/references/utils/#datachart.utils.Grid) arranges rainclouds next to other figures. A raincloud of the flipper lengths (`flipper_data` from the hidden cell) sits beside the body mass one.
...
To draw the value axis on a logarithmic scale, add the `scaley` attribute with a value of the [datachart.constants.SCALE](https://eriknovak.github.io/datachart/0.9.1/references/constants/#datachart.constants.SCALE) constant. The cloud, the rain, and the box all follow the scaled axis.
