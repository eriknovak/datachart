...
This section showcases the pyramid chart. It contains examples of how to create the pyramid chart using the [datachart.charts.PyramidChart](https://eriknovak.github.io/datachart/dev/references/charts/#datachart.charts.PyramidChart) function.
...
As mentioned above, the pyramid charts are created using the `PyramidChart` function found in the [datachart.charts](https://eriknovak.github.io/datachart/dev/references/charts/index.md) module. Let's import it:
...
For more details, see the [datachart.charts.PyramidChart](https://eriknovak.github.io/datachart/dev/references/charts/#datachart.charts.PyramidChart) function.
