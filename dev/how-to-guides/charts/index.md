...
| Chart                                                                                                   | Description                         |
| ------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| [Histogram](https://eriknovak.github.io/datachart/dev/how-to-guides/charts/histogram/index.md)          | The showcase of the histogram.      |
| [Box Plot](https://eriknovak.github.io/datachart/dev/how-to-guides/charts/boxplot/index.md)             | The showcase of the box plot.       |
...
| Utility                                                                                      | Description                                 |
| -------------------------------------------------------------------------------------------- | ------------------------------------------- |
| [Panel](https://eriknovak.github.io/datachart/dev/how-to-guides/utility/panel/index.md)      | How to overlay multiple charts in one plot. |
| [Grid Layout](https://eriknovak.github.io/datachart/dev/how-to-guides/utility/grid/index.md) | How to combine multiple charts in a grid.   |
