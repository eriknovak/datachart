...
This section showcases the network chart. It contains examples of how to create network charts using the [datachart.charts.NetworkChart](https://eriknovak.github.io/datachart/dev/references/charts/#datachart.charts.NetworkChart) function.
...
As mentioned above, the network charts are created using the `NetworkChart` function found in the [datachart.charts](https://eriknovak.github.io/datachart/dev/references/charts/index.md) module. Let's import it:
...
For more details, see the [datachart.charts.NetworkChart](https://eriknovak.github.io/datachart/dev/references/charts/#datachart.charts.NetworkChart) function.
...
A network chart owns its axes: there is no shared coordinate space to overlay other charts on, so [datachart.utils.Panel](https://eriknovak.github.io/datachart/dev/references/utils/#datachart.utils.Panel) rejects a network figure. [datachart.utils.Grid](https://eriknovak.github.io/datachart/dev/references/utils/#datachart.utils.Grid) arranges it next to other figures as an ordinary cell, keeping the layout it was drawn with. The grid pairs the dependency graph with a [datachart.charts.BarChart](https://eriknovak.github.io/datachart/dev/references/charts/#datachart.charts.BarChart) of the module sizes.
