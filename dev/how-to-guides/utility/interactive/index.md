...
| [Scatter Chart](https://eriknovak.github.io/datachart/dev/how-to-guides/charts/scatterchart/index.md) | scatter point | legend label (or the `hue` group), `x`, `y` |
| [Bar Chart](https://eriknovak.github.io/datachart/dev/how-to-guides/charts/barchart/index.md)         | bar           | legend label, category, the bar's own value |
