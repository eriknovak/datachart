...
With multiple charts drawn as subplots, a list of lists assigns the annotations per chart, exactly as `vlines`, `hlines`, `vspans` and `hspans` do. For the full definitions, see the [datachart.typings.TextSettingAttrs](https://eriknovak.github.io/datachart/dev/references/typings/#datachart.typings.TextSettingAttrs) and [datachart.typings.TextStyleAttrs](https://eriknovak.github.io/datachart/dev/references/typings/#datachart.typings.TextStyleAttrs) typings.
