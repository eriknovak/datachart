...
| `ymin`                | Minimum value for the primary value-axis limits. **TYPE:** \`int                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `ymax`                | Maximum value for the primary value-axis limits. **TYPE:** \`int                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `max_cols`     | Maximum number of columns for the flat-list automatic grid. Default: 4. **TYPE:** \`int                                                                                                                                                                                                                                                                       |
| `figsize`      | Size of the combined figure (width, height) in inches. If None, calculated from the first figure's size. **TYPE:** \`FIG_SIZE                                                                                                                                                                                                                                 |
| `sharex`       | Whether to share the x-axis across all subplots. **TYPE:** \`bool                                                                                                                                                                                                                                                                                             |
| `sharey`       | Whether to share the y-axis across all subplots. **TYPE:** \`bool                                                                                                                                                                                                                                                                                             |
| `show_legend`  | Whether to show one legend for the whole grid, with the entries of the first cell that has any. A cell's own legend stays. **TYPE:** \`bool                                                                                                                                                                                                                   |
| `legend`       | The per-figure legend setting: title, location, column count and alignment; each field falls back to the theme. The location picks the grid edge the legend sits on: an outside location its edge, "upper center" the top, "lower center" the bottom, "center left" the left, and any other the right. See LegendSettingAttrs. **TYPE:** \`LegendSettingAttrs |
| `show_grid`    | Which grid lines every cell shows (e.g., "both", "x", "y"); False draws none. Default: each cell's own. **TYPE:** \`SHOW_GRID                                                                                                                                                                                                                                 |
| `xmin`         | Minimum value for the x-axis limits of every cell. **TYPE:** \`float                                                                                                                                                                                                                                                                                          |
| `xmax`         | Maximum value for the x-axis limits of every cell. **TYPE:** \`float                                                                                                                                                                                                                                                                                          |
