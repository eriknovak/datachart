...
StackedAreaChart(
    ...
    *,
    ...
    label_position: LINE_LABEL_POSITION | str | None = None,
...
| `show_labels`    | Whether to print each series' subtitle beside its band end, at the band's midpoint, in the text color. Labels that would overlap spread apart along the value axis. Defaults to False. **TYPE:** \`bool                                                                                                                                                                                                                      |
| `label_position` | Which band end carries the label, a LINE_LABEL_POSITION member: START, END (default), or BOTH. **TYPE:** \`LINE_LABEL_POSITION                                                                                                                                                                                                                                                                                               |
