...
Series on polar axes, as a radar line, an area, bars, or a histogram. The [Radial Chart guide](https://eriknovak.github.io/datachart/dev/how-to-guides/charts/radialchart/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
...
RadialChart(
    data: (
        list[RadialRecordAttrs]
        | list[list[RadialRecordAttrs]]
    ),
    *,
    mark: RADIAL_TYPE | str | None = None,
    title: str | None = None,
...
A radial chart plots series on polar axes: as a line (radar) profile, an area, bars, or a histogram, chosen with `mark`. Use the radar form to compare a few entities across several metrics on a shared scale, and the bar and histogram forms for cyclic categories such as hours, weekdays, or compass directions.
...
| `value_format`    | Format for the values written by show_values — a printf format (e.g. "%.1f") or a {x}-style string. See VALUE_FORMAT. **TYPE:** \`VALUE_FORMAT                                                                                                                                                                                                                                 |
...
| `vlines`          | Not supported on a polar axes. Raises when passed. **TYPE:** `None` **DEFAULT:** `None`                                                                                                                                                                                                                                                                                        |
| `hlines`          | Not supported on a polar axes. Raises when passed. **TYPE:** `None` **DEFAULT:** `None`                                                                                                                                                                                                                                                                                        |
| `dlines`          | Not supported on a polar axes. Raises when passed. **TYPE:** `None` **DEFAULT:** `None`                                                                                                                                                                                                                                                                                        |
| `brackets`        | Not supported on a polar axes. Raises when passed. **TYPE:** `None` **DEFAULT:** `None`                                                                                                                                                                                                                                                                                        |
