...
| `figsize`          | The size of the figure; the cells stay square inside it. Defaults to 2.2 inches per cell. **TYPE:** \`tuple[float, float]                                                                                                                 |
| `show_legend`      | Whether to show the legend of the hue groups (default True when hue is set). **TYPE:** \`bool                                                                                                                                             |
| `legend`           | The legend setting: title, column count and alignment; the legend sits to the right of the matrix. See LegendSettingAttrs. **TYPE:** \`LegendSettingAttrs                                                                                 |
