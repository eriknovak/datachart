...
| `show_labels`    | Whether to print each series' subtitle beside its line end, in the text color. Labels that would overlap spread apart along the value axis. Defaults to False. **TYPE:** \`bool                                                                                                                                                                                                                                         |
| `label_position` | Which line end carries the label, a LINE_LABEL_POSITION member: START, END (default), or BOTH. **TYPE:** \`LINE_LABEL_POSITION                                                                                                                                                                                                                                                                                          |
