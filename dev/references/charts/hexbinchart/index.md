...
Point density on the plane, as colored hexagons. The [Hexbin Chart guide](https://eriknovak.github.io/datachart/dev/how-to-guides/charts/hexbinchart/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
...
| `norm`           | Value normalization method(s) of the colormap; "log" spreads heavy-tailed counts. "centered" and "twoslope" hold vcenter in the middle of the theme's diverging colormap; see NORMALIZE. **TYPE:** \`str                                                                                                                                                                                                                                        |
...
| `value_format`   | Format string(s) for the colorbar tick labels, with the value named x (e.g., "{x:.0f}"). See VALUE_FORMAT. The format field of the colorbar setting wins when set. **TYPE:** \`VALUE_FORMAT                                                                                                                                                                                                                                                     |
