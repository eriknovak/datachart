...
| `dimensions`      | List of dimension names to include and their order. If None, all columns (except hue) are auto-detected. **TYPE:** \`list[str]                                                                                                                                                                                                                                                                                            |
| `hue`             | The key name in data for line coloring. String values color categorically: data points with the same hue value get the same color from color_parallel_hue. Numeric values color continuously along the theme's color_parallel_hue_continuous ramp. **TYPE:** \`str                                                                                                                                                        |
