...
| `layout`       | How the nodes are placed: a NETWORK_LAYOUT constant (default NETWORK_LAYOUT.SPRING). FIXED reads each node's x/y in the 0–1 layout space. **TYPE:** `Optional[Union[NETWORK_LAYOUT, str]]` **DEFAULT:** `None`                                                                                                                                                                                                                                                                                                                                                                                                         |
