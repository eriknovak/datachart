...
| `show_grid`      | Which grid lines to show (e.g., "both", "x", "y"). Off by default for filled contours. **TYPE:** \`SHOW_GRID                                                                                                                                                                                                                                                                                                                          |
...
| `levels`         | Which levels cut the surface: a rule of CONTOUR_LEVELS ("auto", the default, leaves the choice to matplotlib), a target level count, or an explicit list of level values. **TYPE:** \`CONTOUR_LEVELS                                                                                                                                                                                                                                  |
