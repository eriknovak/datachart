...
BASE_THEME: StyleAttrs = {
    ...
    # plot gantt style; the task bars take the plot_bar_* keys (ADR 0049)
    "plot_gantt_bar_height": 0.6,
    "plot_gantt_progress_color": None,
    "plot_gantt_progress_alpha": 1.0,
    "plot_gantt_progress_height": 0.4,
    "plot_gantt_dependency_color": "#555555",
    "plot_gantt_dependency_width": 1.0,
    "plot_gantt_dependency_style": "-|>",
    "plot_gantt_dependency_zorder": 4,
    "plot_gantt_dependency_entry": "top",
    "plot_gantt_summary_height": 0.3,
    "plot_gantt_summary_color": None,
    "plot_gantt_group_gap": 0.5,
    "plot_gantt_milestone_marker": "D",
    "plot_gantt_milestone_size": 9,
    "plot_gantt_today_color": "#C0392B",
    ...
    "plot_dumbbell_size": 64,
    "plot_dumbbell_start_marker": "o",
    "plot_dumbbell_end_marker": "o",
    "plot_dumbbell_edge_width": 0.5,
    "plot_dumbbell_edge_color": "#FFFFFF",
    "plot_dumbbell_zorder": 3,
    "plot_dumbbell_connector_color": "#B0B0B0",
    ...
    # plot image style; "auto" fills the extent, keeps the axes (ADR 0060)
