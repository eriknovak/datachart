...
This section showcases the grid. It contains examples of how to arrange several charts in a grid of cells using the [datachart.utils.Grid](https://eriknovak.github.io/datachart/references/utils/#datachart.utils.Grid) function.
...
A grid does not draw data of its own: it takes figures already drawn by the chart functions of the [datachart.charts](https://eriknovak.github.io/datachart/references/charts/index.md) module — any of the charts from the [Charts](https://eriknovak.github.io/datachart/how-to-guides/charts/index.md) guides — and redraws each one into its own cell of one combined figure. Where the [Panel](https://eriknovak.github.io/datachart/how-to-guides/utility/panel/index.md) overlays figures in one coordinate space, the grid keeps every figure in a coordinate space of its own: reach for a panel to read series against each other, and for a grid to compare them side by side. The `Grid` function is found in the [datachart.utils](https://eriknovak.github.io/datachart/references/utils/index.md) module. Let's import it, together with the two chart functions the examples below arrange:
...
For more details, see the [datachart.utils.Grid](https://eriknovak.github.io/datachart/references/utils/#datachart.utils.Grid) function. The reference is generated from the function itself, so it always lists the current parameters and layout options.
...
The full list of parameters is in the [datachart.utils.Grid](https://eriknovak.github.io/datachart/references/utils/#datachart.utils.Grid) function. The look of each figure — colors, line widths, markers, labels — is set on the chart itself through its attributes and `style`; see the guide of each chart in the [Charts](https://eriknovak.github.io/datachart/how-to-guides/charts/index.md) section.
...
To save the grid as an image, use the [datachart.utils.save_figure](https://eriknovak.github.io/datachart/references/utils/#datachart.utils.save_figure) function.
