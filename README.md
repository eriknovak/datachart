...
| **Distributions** | [Histogram], [BoxPlot], [ViolinPlot], [SwarmPlot], [RaincloudPlot], [RidgelinePlot] | shape and spread of one variable, per group; many groups stacked in ridges |
| **Relationships** | [ScatterChart], [Heatmap], [ContourChart], [HexbinChart], [ParallelCoords], [NetworkChart], [ScatterMatrix], [ImageChart], [BasemapChart] | two-variable correlation, matrices, dense 2-D density, many dimensions, who is linked to whom, every pair at once, a map or picture under the data |
...
[RidgelinePlot]: https://eriknovak.github.io/datachart/latest/how-to-guides/charts/ridgelineplot/
...
[ImageChart]: https://eriknovak.github.io/datachart/latest/how-to-guides/charts/imagechart/
[BasemapChart]: https://eriknovak.github.io/datachart/latest/how-to-guides/charts/basemapchart/
