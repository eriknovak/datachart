...
Median, quartiles, whiskers, and outliers per group. The [Box Plot guide](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/boxplot/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
