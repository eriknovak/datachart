...
Two series as horizontal bars mirrored around a shared category axis. The [Pyramid Chart guide](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/pyramidchart/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
