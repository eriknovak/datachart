...
| Parameter                                    | Constant                                                                                                                                                                                                                                           |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `layout`                                     | [`NETWORK_LAYOUT`](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.NETWORK_LAYOUT)                                                                                                                          |
| `label_position`                             | [`NETWORK_LABEL_POSITION`](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.NETWORK_LABEL_POSITION)                                                                                                          |
...
The full list of style attributes is in the [datachart.typings.NetworkStyleAttrs](https://eriknovak.github.io/datachart/0.10.1/references/charts/networkchart/#datachart.typings.NetworkStyleAttrs) type; the full list of parameters is in the [datachart.charts.NetworkChart](https://eriknovak.github.io/datachart/0.10.1/references/charts/networkchart/#datachart.charts.NetworkChart) reference.

### Title and figure size

A network has no axes to label, so the title carries the whole message: `title` says what the nodes and the edges are. The layout always keeps a square aspect, so a wide figure leaves empty space beside the drawing rather than stretching it; `figsize` takes a `(width, height)` tuple in inches or one of the [FIG_SIZE](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.FIG_SIZE) presets, and `FIG_SIZE.SQUARE` fits a network best.
...
Where a node sits is not data: the layout decides it, and the layout decides what the picture seems to say. `layout` picks the rule from [NETWORK_LAYOUT](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.NETWORK_LAYOUT), and each one tells the truth about something different.
...
A network shows the structure; a second chart puts numbers to it. A network owns its axes, and its layout space is not a coordinate space another chart can share, so [datachart.utils.Panel](https://eriknovak.github.io/datachart/0.10.1/references/utils/#datachart.utils.Panel) rejects a network figure. [datachart.utils.Grid](https://eriknovak.github.io/datachart/0.10.1/references/utils/#datachart.utils.Grid) arranges it beside other charts, each in its own cell and with the layout it was drawn with; a `layout_spec` gives a cell more than one column, and the [Grid](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/utility/grid/index.md) guide covers the other layout options. The example sets the bridge roles from [Emphasis](#emphasis), drawn on the fixed rows, beside a [BarChart](https://eriknovak.github.io/datachart/0.10.1/references/charts/barchart/#datachart.charts.BarChart) of the ties per family, the Medici highlighted in both.
