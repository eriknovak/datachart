...
| Parameter                                    | Constant                                                                                                                                                                                                                                           |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `period`                                     | [`GANTT_DATE_PERIOD`](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.GANTT_DATE_PERIOD)                                                                                                                    |
| `show_values`                                | [`GANTT_VALUE`](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.GANTT_VALUE)                                                                                                                                |
| `sort_by`                                    | [`GANTT_SORT_KEY`](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.GANTT_SORT_KEY)                                                                                                                          |
| `style={"plot_gantt_dependency_entry": ...}` | [`GANTT_ARROW_ENTRY`](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.GANTT_ARROW_ENTRY)                                                                                                                    |
...
| `xticks_format`                              | [`DATE_FORMAT`](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.DATE_FORMAT)                                                                                                                                |

The full list of style attributes is in the [datachart.typings.GanttStyleAttrs](https://eriknovak.github.io/datachart/0.10.1/references/charts/ganttchart/#datachart.typings.GanttStyleAttrs) type, and the task record keys in [datachart.typings.GanttTaskAttrs](https://eriknovak.github.io/datachart/0.10.1/references/charts/ganttchart/#datachart.typings.GanttTaskAttrs); the full list of parameters is in the [datachart.charts.GanttChart](https://eriknovak.github.io/datachart/0.10.1/references/charts/ganttchart/#datachart.charts.GanttChart) reference.
...
A gantt chart draws time along one axis and tasks down the other, so there is no shared coordinate space to overlay another chart on: [datachart.utils.Panel](https://eriknovak.github.io/datachart/0.10.1/references/utils/#datachart.utils.Panel) rejects a gantt figure. [datachart.utils.Grid](https://eriknovak.github.io/datachart/0.10.1/references/utils/#datachart.utils.Grid) arranges it beside other charts, each in its own cell ([Grid](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/utility/grid/index.md) guide). The example sets the schedule over a bar chart of the task days each trade books, the number a builder prices the job by.
