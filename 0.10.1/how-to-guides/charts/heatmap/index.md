...
The full list of style attributes is in the [datachart.typings.HeatmapStyleAttrs](https://eriknovak.github.io/datachart/0.10.1/references/charts/heatmap/#datachart.typings.HeatmapStyleAttrs) type; the full list of parameters is in the [datachart.charts.Heatmap](https://eriknovak.github.io/datachart/0.10.1/references/charts/heatmap/#datachart.charts.Heatmap) reference.
...
When the cells to mark do not follow from one threshold, `data` takes an `emphasis` grid aligned with `z`, one role per cell: `"highlight"`, `"background"`, or `None` to leave the cell as it is ([EMPHASIS](https://eriknovak.github.io/datachart/0.10.1/references/constants/#datachart.constants.EMPHASIS)). A role in the grid wins over the rule. Marking each city's warmest month, and muting the rest, shows Sydney's summer at the start of the year, Singapore's in May and June, and Cairo's July and August tied; the [Highlighting](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/styling/highlighting/#emphasis-picked-by-a-rule) guide covers emphasis across every chart.
