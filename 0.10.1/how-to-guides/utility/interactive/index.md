...
| keep the figure as an image after inspecting it | `save_figure`                       | [Saving Figures](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/utility/saving/index.md) |
...
*Does it still work once charts are combined?* Hover follows the marks through composition: it works on every series of a [Panel](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/utility/panel/index.md) overlay, including those on the secondary axis, which report the panel's right axis label, and in every cell of a [Grid](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/utility/grid/index.md), where each cell's marks report that cell's labels. A figure composed from figures keeps the hover of each.
...
| ----------------------------------------------------------------------------------------------------------------- | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Line Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/linechart/index.md)                | line point                    | legend label, `x`, `y`                                                                                                                                      |
| [Stacked Area Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/stackedareachart/index.md) | band, at the nearest point    | legend label, `x`, the series' own `y` (never the stack total)                                                                                              |
| [Bump Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/bumpchart/index.md)                | line, at the nearest period   | legend label, `x`, the rank as `y`, the original `value`                                                                                                    |
| [Bar Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/barchart/index.md)                  | bar                           | legend label, category, the bar's own value (never the stack total)                                                                                         |
| [Pyramid Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/pyramidchart/index.md)          | bar                           | legend label, category, the value as passed, positive                                                                                                       |
| [Gantt Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/ganttchart/index.md)              | task bar                      | legend label, `task`, `start`, `end`, `duration` in days, and `progress` when set                                                                           |
| [Dumbbell Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/dumbbellchart/index.md)        | start or end dot              | legend label (the endpoint name), category, value                                                                                                           |
| [Radial Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/radialchart/index.md)            | point, bar, or bin            | legend label, `angle` (the category, or a bin's degree range), `radius`                                                                                     |
| [Histogram](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/histogram/index.md)                 | bin                           | legend label, the bin's range, its count (or density)                                                                                                       |
| [Box Plot](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/boxplot/index.md)                    | box                           | legend label, category, `median`, `q1`, `q3`, `min`, `max`                                                                                                  |
| [Violin Plot](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/violinplot/index.md)              | body                          | legend label (or the split value), category, `median`, `q1`, `q3`, `min`, `max`                                                                             |
| [Swarm Plot](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/swarmplot/index.md)                | point                         | legend label, category, value                                                                                                                               |
| [Raincloud Plot](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/raincloudplot/index.md)        | box, body, or rain point      | as the box, violin, and swarm marks                                                                                                                         |
| [Ridgeline Plot](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/ridgelineplot/index.md)        | ridge                         | legend label, category, `median`, `q1`, `q3`, `min`, `max`                                                                                                  |
| [Scatter Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/scatterchart/index.md)          | point                         | legend label (or the `hue` group), `x`, `y`                                                                                                                 |
| [Heatmap](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/heatmap/index.md)                     | cell                          | legend label, `x`, `y`, `value`                                                                                                                             |
| [Calendar Heatmap](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/calendarheatmap/index.md)    | day cell                      | legend label, `date`, `value`                                                                                                                               |
| [Contour Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/contourchart/index.md)          | level line or filled band     | legend label, `level` (a band's two levels)                                                                                                                 |
| [Hexbin Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/hexbinchart/index.md)            | hexagon                       | legend label, `x`, `y` (the cell center), `count` (or the reduced `c` under its reducer's name)                                                             |
| [Parallel Coordinates](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/parallelcoords/index.md) | row line, at the nearest axis | the `hue` value (or the legend label), the axis name and the row's value there                                                                              |
| [Network Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/networkchart/index.md)          | node or edge                  | node: its label, `degree` (`in` / `out` when directed, the weight sum when weighted), its `group` and `size` when given; edge: `source`, `target`, `weight` |
| [Scatter Matrix](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/scattermatrix/index.md)        | point, bin, or density curve  | as the scatter chart and histogram marks; a density curve reports the legend label (the `hue` group), `x`, and the density as `y`                           |
| [Sankey Chart](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/sankeychart/index.md)            | node or link                  | node: its name, `flow`; link: `source`, `target`, `flow`                                                                                                    |
| [Treemap](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/charts/treemap/index.md)                     | tile or group band            | its label, `value` (a band's group total)                                                                                                                   |
...
For an outlier that should stay named on the static chart too, add a `texts` note once it is identified; the [Text Annotations](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/utility/annotations/index.md) guide shows how.

### Example 2: Which Axis Is That Line On? (Hover in a Two-Axis Panel)

A [Panel](https://eriknovak.github.io/datachart/0.10.1/how-to-guides/utility/panel/index.md) that overlays a count on a rate puts one series on each value axis, and a reader who zooms in loses track of which is which. Hovering settles it: a series on the secondary axis reports its value under the panel's `ylabel_right`, one on the primary axis under `ylabel_left`. The legend label on the first line names the series.
