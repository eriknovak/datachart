...
This section showcases the parallel coordinates chart. It contains examples of how to create parallel coordinates charts using the [datachart.charts.ParallelCoords](https://eriknovak.github.io/datachart/0.8.1/references/charts/#datachart.charts.ParallelCoords) function.
...
As mentioned above, the parallel coordinates charts are created using the `ParallelCoords` function found in the [datachart.charts](https://eriknovak.github.io/datachart/0.8.1/references/charts/index.md) module. Let's import it:
...
For more details, see the [datachart.charts.ParallelCoords](https://eriknovak.github.io/datachart/0.8.1/references/charts/#datachart.charts.ParallelCoords) function.
...
| [datachart.constants.LINE_MARKER](https://eriknovak.github.io/datachart/0.8.1/references/constants/#datachart.constants.LINE_MARKER) | The line markers (circle, square, etc.). |
