...
<div class="dc-cards">
  ...
  <a class="dc-card" href="https://github.com/eriknovak/datachart">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="6" cy="6" r="2.5"/><circle cx="18" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><path d="M6 8.5v7M18 8.5c0 4-4 4-9 6"/></svg>
    <h3>Source and changelog</h3>
    <p>Bug reports, feature requests, and pull requests are welcome on GitHub.</p>
    <span class="dc-card__more">Go to the repository &rarr;</span>
  </a>
</div>
