...
Every theme is a complete [`StyleAttrs`](https://eriknovak.github.io/datachart/0.10.0/references/typings/#datachart.typings.StyleAttrs) dictionary, named for its visual trait. Apply one with [`config.set_theme`](https://eriknovak.github.io/datachart/0.10.0/references/config/#datachart.config.Config.set_theme) and the member of [`THEME`](https://eriknovak.github.io/datachart/0.10.0/references/constants/#datachart.constants.THEME) in the last column; the [Theme Gallery](https://eriknovak.github.io/datachart/0.10.0/how-to-guides/styling/theme-gallery/index.md) shows each on six charts, and the [Themes guide](https://eriknovak.github.io/datachart/0.10.0/how-to-guides/styling/themes/index.md) shows how to adjust one or build your own.
