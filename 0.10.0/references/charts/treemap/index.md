...
Part-of-whole data as nested rectangles sized by value. The [Treemap guide](https://eriknovak.github.io/datachart/0.10.0/how-to-guides/charts/treemap/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
