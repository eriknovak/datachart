...
Nodes joined by edges, placed by a layout. The [Network Chart guide](https://eriknovak.github.io/datachart/0.10.0/how-to-guides/charts/networkchart/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
