...
Series on polar axes, as a radar line, an area, bars, or a histogram. The [Radial Chart guide](https://eriknovak.github.io/datachart/0.10.0/how-to-guides/charts/radialchart/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
