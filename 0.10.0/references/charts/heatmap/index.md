...
A two-dimensional matrix as colored cells. The [Heatmap guide](https://eriknovak.github.io/datachart/0.10.0/how-to-guides/charts/heatmap/index.md) shows every feature on real data; this page is the contract: the function, the shape of its data, the keys `style` takes, and the constant each parameter accepts.
...
| `norm`                | Value normalization method(s). **TYPE:** \`str                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
