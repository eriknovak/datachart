...
The full list of style attributes is in the [datachart.typings.BarStyleAttrs](https://eriknovak.github.io/datachart/0.10.0/references/charts/barchart/#datachart.typings.BarStyleAttrs) type; the full list of parameters is in the [datachart.charts.BarChart](https://eriknovak.github.io/datachart/0.10.0/references/charts/barchart/#datachart.charts.BarChart) reference.
...
A ranking reads best top to bottom, and long category names read best unrotated. Horizontal bars give both: `orientation=ORIENTATION.HORIZONTAL` ([ORIENTATION](https://eriknovak.github.io/datachart/0.10.0/references/constants/#datachart.constants.ORIENTATION)) puts the categories on the y-axis and the values on the x-axis, so the axis labels and the grid swap with it. The first data point is drawn at the bottom, so the data is reversed to keep the ranking top-down.
