...
| Parameter                                    | Constant                                                                                                                                                                                                                                           |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `diagonal`                                   | [`SCATTER_MATRIX_DIAGONAL`](https://eriknovak.github.io/datachart/0.10.0/references/constants/#datachart.constants.SCATTER_MATRIX_DIAGONAL)                                                                                                        |
...
A scatter matrix owns its whole grid of axes, so it cannot be overlaid on another chart with [datachart.utils.Panel](https://eriknovak.github.io/datachart/0.10.0/references/utils/#datachart.utils.Panel). It can sit beside other charts, or beside another matrix, in a [datachart.utils.Grid](https://eriknovak.github.io/datachart/0.10.0/references/utils/#datachart.utils.Grid).
